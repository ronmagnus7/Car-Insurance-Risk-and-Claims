# Car-Insurance-Risk-and-Claims
Car Insurance Risk and Claims is a Power BI project that analyzes customer, vehicle, and insurance claim data to identify claim patterns and risk factors.
